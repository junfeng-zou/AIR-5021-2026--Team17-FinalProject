...
def dobot_pouring_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    """DOBOT CR5 pouring dataset. Actions are already in standard 7-dim EEF delta format."""
    # Action is already [dx, dy, dz, droll, dpitch, dyaw, gripper] — no transform needed
    # language_instruction is already in the trajectory — no extraction needed
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "dobot_pouring": dobot_pouring_dataset_transform,
}
